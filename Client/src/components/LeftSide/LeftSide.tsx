...
export default function SidebarDemo() {
  ...
  return (
    <div
  className={cn(
    " rounded-xl flex flex-col  bg-gray-100 dark:bg-gray-900 h-[89vh] w-full max-w-5xl mx-auto  dark:border-gray-700 overflow-hidden shadow-lg"
  )}
>
<div className="xl:hidden fixed bottom-0 left-0 w-full bg-gray-100 dark:bg-gray-900 shadow-lg flex justify-around py-3 border-t border-gray-300 dark:border-gray-700 z-50">
  {links.map((link, idx) => (
    <Link key={idx} href={link.href} className="flex flex-col items-center text-gray-700 dark:text-gray-300">
      {link.icon}

...
export default function Profile() {
 ...
 const [IscloudinaryImageAtModal, setIsCloudinaryImageAtModal] = useState(false);
  const [cloudinaryImageAtModal, setCloudinaryImageAtModal] = useState<string>();
    ...
    return (
      <div className="fixed inset-0 bg-gray-900 bg-opacity-70 flex items-center justify-center z-50">
        ...
        <div className="flex justify-between items-center mb-4 ">
          ...
          <FaUserAlt className="absolute mx-auto mb-4 text-gray-400" size={25} />
...
/>
                  ...
                  (
                    <CldImage
                    src={userDetail?.image || cloudinaryImageAtModal || "data:image/png;base64,"}
                    alt={userDetail?.name}
                    width={40}
                    height={60}
                  ...
                  {userDetail?.name || "Unknown User"}
                    ...
                    <p className="text-xs text-gray-500">@{userDetail?.username || "No username available"}</p>
  ...
  <div className="bg-gradient-to-r from-blue-600 to-purple-800 py-12 flex justify-center">
    <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-8 ">
      ...
      <div className="flex-1 space-y-6">
        <span className="text-3xl md:text-4xl font-bold">{username || user?.username || "No Username Set"}</span>
        {editingUsername ? (
        ...
        <p className="text-lg text-gray-200">Email: {email || user?.email || "Not Provided"}</p>
        ...
        <p className="text-sm text-gray-400">Joined: {new Date(createdAt2 || user?.createdAt || "empty").toLocaleDateString()}</p>
        {signedInUser && (
          <button
            onClick={() => signOut()}
        ...
        {!signedInUser && (
        <FollowButton currentUserId={session.user?.id} targetUserId={params.get("userId") || ""}/>
      )} 
    ...
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-md text-center">
        <h2 className="text-2xl font-bold">
          {new Date(createdAt2 || user?.createdAt || "empty").toLocaleDateString()}
        </h2>

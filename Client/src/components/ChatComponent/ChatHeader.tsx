...
const ChatHeader = () => {
  ...
  const [selectedChatType, setSelectedChatType] = useState("channel");
  ...
  return (
    <div className="h-[10vh] border-b-2 bg-gray-900 text-white border-[#2f303b] flex items-center justify-between">

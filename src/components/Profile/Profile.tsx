    ...
    const fetchUserData = async () => {
      ...
      if (sessionData) {
        const userData: UserProfile = {
          ...
          interest: sessionData.user?.interest
            ? Array.isArray(sessionData.user?.interest)
              ? sessionData.user?.interest
              : sessionData.user?.interest.split(",")
            : [],
      ...
      >
        <div className="flex flex-col items-center ">
          ...
          <div className="mb-4 text-center relative">
            <h2 className="text-3xl font-bold">{username || "No username set"}</h2>
            {editingUsername ? (
          ...
          <div className="mb-6 text-center">
            ...
            <p className="text-lg text-gray-200">{email || "No email provided"}</p>
          </div>
  
          {/* Joined Date */}
          <p className="text-sm text-gray-400 mb-6">
            Joined: {new Date(createdAt2 || "empty").toLocaleDateString()}
          </p>
